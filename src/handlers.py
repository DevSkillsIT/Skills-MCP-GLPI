...
class MCPHandler:
    ...
    def _register_tools(self) -> Dict[str, Any]:
        ...
        # ============= TICKETS (12 tools) =============
        ticket_methods = [
            ("glpi_list_tickets", ticket_tools.list_tickets),
            ("glpi_get_ticket", ticket_tools.get_ticket),
            ("glpi_get_ticket_by_id", ticket_tools.get_ticket_by_id),
            ("glpi_get_ticket_by_number", ticket_tools.get_ticket_by_number),
            ("glpi_create_ticket", ticket_tools.create_ticket),
            ("glpi_update_ticket", ticket_tools.update_ticket),
            ("glpi_delete_ticket", ticket_tools.delete_ticket),
            ("glpi_assign_ticket", ticket_tools.assign_ticket),
            ("glpi_close_ticket", ticket_tools.close_ticket),
            ("glpi_find_similar_tickets", ticket_tools.find_similar_tickets),
            ("glpi_search_similar_tickets", ticket_tools.search_similar_tickets),
            ("glpi_search_tickets", ticket_tools.search_tickets),
            ("glpi_get_ticket_stats", ticket_tools.get_ticket_stats),
            ("glpi_get_ticket_history", ticket_tools.get_ticket_history),
            ("glpi_add_ticket_followup", ticket_tools.add_ticket_followup),
            ("glpi_post_private_note", ticket_tools.post_private_note),
            ("glpi_get_ticket_followups", ticket_tools.get_ticket_followups),
            ("glpi_resolve_ticket", ticket_tools.resolve_ticket),
        ]
        ...
        # ============= ASSETS (12 tools) =============
        asset_methods = [
            ("glpi_list_assets", asset_tools.list_assets),
            ("glpi_get_asset", asset_tools.get_asset),
            ("glpi_create_asset", asset_tools.create_asset),
            ("glpi_update_asset", asset_tools.update_asset),
            ("glpi_delete_asset", asset_tools.delete_asset),
            ("glpi_search_assets", asset_tools.search_assets),
            ("glpi_get_asset_reservations", asset_tools.get_asset_reservations),
            ("glpi_create_reservation", asset_tools.create_reservation),
            ("glpi_list_reservations", asset_tools.list_reservations),
            ("glpi_list_reservable_items", asset_tools.list_reservable_items),
            ("glpi_update_reservation", asset_tools.update_reservation),
            ("glpi_get_asset_stats", asset_tools.get_asset_stats),
            ("glpi_list_computers", asset_tools.list_computers),
            ("glpi_get_computer_details", asset_tools.get_computer_details),
            ("glpi_list_monitors", asset_tools.list_monitors),
            ("glpi_get_monitor", asset_tools.get_monitor),
            ("glpi_list_software", asset_tools.list_software),
            ("glpi_get_software", asset_tools.get_software),
            ("glpi_list_devices", asset_tools.list_devices),
            ("glpi_get_device", asset_tools.get_device),
        ]
        ...
        # ============= ADMIN (13 tools) =============
        admin_methods = [
            ("glpi_list_users", admin_tools.list_users),
            ("glpi_search_users", admin_tools.search_users),
            ("glpi_get_user", admin_tools.get_user),
            ("glpi_create_user", admin_tools.create_user),
            ("glpi_update_user", admin_tools.update_user),
            ("glpi_delete_user", admin_tools.delete_user),
            ("glpi_list_groups", admin_tools.list_groups),
            ("glpi_get_group", admin_tools.get_group),
            ("glpi_create_group", admin_tools.create_group),
            ("glpi_list_entities", admin_tools.list_entities),
            ("glpi_get_entity", admin_tools.get_entity),
            ("glpi_list_locations", admin_tools.list_locations),
            ("glpi_get_location", admin_tools.get_location),
        ]
        ...
        # ============= WEBHOOKS (12 tools) =============
        webhook_methods = [
            ("glpi_list_webhooks", webhook_tools.list_webhooks),
            ("glpi_get_webhook", webhook_tools.get_webhook),
            ("glpi_create_webhook", webhook_tools.create_webhook),
            ("glpi_update_webhook", webhook_tools.update_webhook),
            ("glpi_delete_webhook", webhook_tools.delete_webhook),
            ("glpi_test_webhook", webhook_tools.test_webhook),
            ("glpi_get_webhook_deliveries", webhook_tools.get_webhook_deliveries),
            ("glpi_trigger_webhook", webhook_tools.trigger_webhook),
            ("glpi_get_webhook_stats", webhook_tools.get_webhook_stats),
            ("glpi_enable_webhook", webhook_tools.enable_webhook),
            ("glpi_disable_webhook", webhook_tools.disable_webhook),
            ("glpi_retry_failed_deliveries", webhook_tools.retry_failed_deliveries),
        ]
        ...
        ai_methods = [
            ("glpi_trigger_ai_analysis", ai_tools.trigger_ai_analysis),
            ("glpi_get_ai_analysis_result", ai_tools.get_ai_analysis_result),
            ("glpi_publish_ai_response", ai_tools.publish_ai_response),
        ]
        ...
        # Tool 1: prompts/list
        tools["glpi_list_prompts"] = {
            "name": "glpi_list_prompts",
            "description": "Prompts profissionais no GLPI — catálogo de 15 modelos prontos para gestores e analistas de suporte técnico. Use quando precisar descobrir quais relatórios e análises estão disponíveis no sistema GLPI. Retorna nome, descrição, categoria (gestão/suporte), público-alvo e argumentos de cada prompt.",
            "input_schema": {"type": "object"},
        ...
        tools["glpi_get_prompt"] = {
            "name": "glpi_get_prompt",
            "description": "Prompt e execução de modelo no GLPI — processa um relatório ou análise específica com argumentos customizados. Use quando precisar gerar relatório de SLA, tendências, produtividade ou investigação no GLPI. Retorna resultado em formato compact (10 linhas) e detailed (Markdown completo).",
            "input_schema": {
                "type": "object",
                "properties": {
                    "name": {
        ...
        logger.info(
            f"Registered {len(tools)} MCP tools across 6 categories (tickets, assets, admin, webhooks, ai, prompts)"
        )
        return tools
        ...
        try:
            ...
            if method == "initialize":
                ...
                result = {
                    ...
                    "serverInfo": {"name": "mcp-glpi", "version": "1.0.0"},
