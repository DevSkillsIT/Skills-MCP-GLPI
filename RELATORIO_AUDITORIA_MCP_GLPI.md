...
|---|-------------|-----------|
| 1 | list_tickets | glpi_list_tickets |
| 2 | get_ticket | glpi_get_ticket |
| 3 | get_ticket_by_id | glpi_get_ticket_by_id |
| 4 | get_ticket_by_number | glpi_get_ticket_by_number |
| 5 | create_ticket | glpi_create_ticket |
| 6 | update_ticket | glpi_update_ticket |
| 7 | delete_ticket | glpi_delete_ticket |
| 8 | assign_ticket | glpi_assign_ticket |
| 9 | close_ticket | glpi_close_ticket |
| 10 | add_ticket_followup | glpi_add_ticket_followup |
| 11 | get_ticket_followups | glpi_get_ticket_followups |
| 12 | search_tickets | glpi_search_tickets |
| 13 | get_ticket_stats | glpi_get_ticket_stats |
| 14 | find_similar_tickets | glpi_find_similar_tickets |
| 15 | get_sla_info | glpi_get_sla_info |
| 16 | escalate_ticket | glpi_escalate_ticket |
| 17 | merge_tickets | glpi_merge_tickets |
| 18 | get_ticket_timeline | glpi_get_ticket_timeline |
| 19 | list_assets | glpi_list_assets |
| 20 | get_asset | glpi_get_asset |
| 21 | create_asset | glpi_create_asset |
| 22 | update_asset | glpi_update_asset |
| 23 | delete_asset | glpi_delete_asset |
| 24 | search_assets | glpi_search_assets |
| 25 | get_asset_types | glpi_get_asset_types |
| 26 | get_asset_connections | glpi_get_asset_connections |
| 27 | get_software_list | glpi_get_software_list |
| 28 | get_software_licenses | glpi_get_software_licenses |
| 29 | get_network_equipment | glpi_get_network_equipment |
| 30 | get_network_ports | glpi_get_network_ports |
| 31 | list_devices | glpi_list_devices |
| 32 | get_device_info | glpi_get_device_info |
| 33 | get_asset_history | glpi_get_asset_history |
| 34 | create_reservation | glpi_create_reservation |
| 35 | get_asset_contracts | glpi_get_asset_contracts |
| 36 | get_asset_documents | glpi_get_asset_documents |
| 37 | link_asset_to_ticket | glpi_link_asset_to_ticket |
| 38 | get_asset_financial_info | glpi_get_asset_financial_info |
| 39 | list_users | glpi_list_users |
| 40 | get_user | glpi_get_user |
| 41 | create_user | glpi_create_user |
| 42 | update_user | glpi_update_user |
| 43 | search_users | glpi_search_users |
| 44 | list_groups | glpi_list_groups |
| 45 | get_group | glpi_get_group |
| 46 | list_entities | glpi_list_entities |
| 47 | get_entity | glpi_get_entity |
| 48 | get_entity_tree | glpi_get_entity_tree |
| 49 | get_active_sessions | glpi_get_active_sessions |
| 50 | get_system_logs | glpi_get_system_logs |
| 51 | get_glpi_config | glpi_get_glpi_config |
| 52 | create_webhook | glpi_create_webhook |
| 53 | list_webhooks | glpi_list_webhooks |
| 54 | get_webhook | glpi_get_webhook |
| 55 | update_webhook | glpi_update_webhook |
| 56 | delete_webhook | glpi_delete_webhook |
| 57 | test_webhook | glpi_test_webhook |
| 58 | get_webhook_logs | glpi_get_webhook_logs |
| 59 | get_webhook_stats | glpi_get_webhook_stats |
| 60 | enable_webhook | glpi_enable_webhook |
| 61 | disable_webhook | glpi_disable_webhook |
| 62 | retry_webhook | glpi_retry_webhook |
| 63 | purge_webhook_logs | glpi_purge_webhook_logs |
| 64 | ai_summarize_ticket | glpi_ai_summarize_ticket |
| 65 | ai_suggest_solution | glpi_ai_suggest_solution |
| 66 | ai_classify_ticket | glpi_ai_classify_ticket |
| 67 | prompts_list | glpi_list_prompts |
| 68 | prompts_get | glpi_get_prompt |
